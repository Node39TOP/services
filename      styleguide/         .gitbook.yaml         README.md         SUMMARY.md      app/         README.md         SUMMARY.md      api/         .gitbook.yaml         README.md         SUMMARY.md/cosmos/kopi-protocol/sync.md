...
**Download snapshot: snapshort**: height 1142888| **Daily** | **db**: goleveldb | **pruning**: 100/0/50 | **indexer**: null
...
curl https://file.node39.top/testnet/kopi/kopi-snapshot-1142888.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.kopid
